        ...
        <div class="col-lg-8 col-md-12">
            <div class="card shadow-sm border-0 rounded-3">
                <div
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small
                                class="text-white-50">{{ $item->exists ? 'Perbarui data pelanggan terdaftar' : 'Tambahkan data pelanggan baru ke sistem' }}</small>
                        </div>
                    </div>
                ...
                <div class="card-body p-4">
                    <form
                        action="{{ $item->exists ? route('pelanggan.update', $item->kode_pelanggan) : route('pelanggan.store') }}"
                        method="POST">
                        @csrf
                        @if ($item->exists)
                            @method('PUT')
                        ...
                        <div class="row g-3 mb-4">
                            <!-- Kode Pelanggan -->
                            <div class="col-md-6">
                                <label for="kode_pelanggan" class="form-label fs-7 fw-bold text-secondary">Kode
                                    Pelanggan</label>
                                <div class="input-group input-group-merge input-group-sm">
                                    <span
                                        class="input-group-text {{ $item->exists ? 'bg-light' : 'bg-white' }} border-end-0 text-secondary">
                                    ...
                                    <input type="text" name="kode_pelanggan" id="kode_pelanggan"
                                        ...
                                        value="{{ old('kode_pelanggan', $item->kode_pelanggan) }}"
                            ...
                            <!-- Nama Pelanggan -->
                            <div class="col-md-6">
                                <label for="nama_pelanggan" class="form-label fs-7 fw-bold text-secondary">Nama
                                    Pelanggan</label>
                                <div class="input-group input-group-merge input-group-sm">
                                    ...
                                    <input type="text" name="nama_pelanggan" id="nama_pelanggan"
                                        ...
                                        value="{{ old('nama_pelanggan', $item->nama_pelanggan) }}" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge input-group-sm">
                                    ...
                                    <input type="text" name="no_hp_pelanggan" id="no_hp_pelanggan"
                                        ...
                                        value="{{ old('no_hp_pelanggan', $item->no_hp_pelanggan) }}" required>
                                </div>
                            ...
                            <!-- Limit -->
                            <div class="col-md-6">
                                <label for="limit_pelanggan" class="form-label fs-7 fw-bold text-secondary">Limit Piutang /
                                    Kredit</label>
                                <div class="input-group input-group-merge input-group-sm">
                                    <span class="input-group-text bg-white border-end-0 text-secondary">
                                        Rp
                                    ...
                                    <input type="number" name="limit_pelanggan" id="limit_pelanggan"
                                        ...
                                        placeholder="200000"
                                        value="{{ old('limit_pelanggan', $item->exists ? (int) $item->limit_pelanggan : 200000) }}"
                                        required>
                                </div>
                            ...
                            <!-- Metode Bayar -->
                            <div class="col-md-6">
                                <label for="metode_bayar" class="form-label fs-7 fw-bold text-secondary">Metode
                                    Bayar</label>
                                <select name="metode_bayar" id="metode_bayar"
                                    class="form-select form-select-sm @error('metode_bayar') is-invalid @enderror" required>
                                    <option value="Cash"
                                        {{ old('metode_bayar', $item->metode_bayar) === 'Cash' ? 'selected' : '' }}>Cash
                                    </option>
                                    <option value="Kredit"
                                        {{ old('metode_bayar', $item->metode_bayar) === 'Kredit' ? 'selected' : '' }}>
                                        Kredit</option>
                                    <option value="Transfer"
                                        {{ old('metode_bayar', $item->metode_bayar) === 'Transfer' ? 'selected' : '' }}>
                                        Transfer</option>
                                </select>
                                @error('metode_bayar')
                                    <div class="text-danger small mt-1"><i
                            ...
                            <!-- Jenis Pelanggan -->
                            <div class="col-md-6">
                                <label for="jenis_pelanggan" class="form-label fs-7 fw-bold text-secondary">Jenis
                                    Pelanggan</label>
                                <select name="jenis_pelanggan" id="jenis_pelanggan"
                                    class="form-select form-select-sm @error('jenis_pelanggan') is-invalid @enderror">
                                    <option value="0"
                                        {{ old('jenis_pelanggan', $item->jenis_pelanggan) != '1' ? 'selected' : '' }}>
                                        Regular (Blokir jika Overdue)</option>
                                    <option value="1"
                                        {{ old('jenis_pelanggan', $item->jenis_pelanggan) == '1' ? 'selected' : '' }}>
                                        Khusus (Bisa transaksi saat Overdue)</option>
                                </select>
                            ...
                            <!-- Sub Wilayah -->
                            <div class="col-md-6">
                                <label for="sub_wilayah" class="form-label fs-7 fw-bold text-secondary">Sub
                                    Wilayah</label>
