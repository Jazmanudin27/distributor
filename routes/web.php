...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('/laporan/stok/saldo-awal/recalculate', [LaporanStokController::class, 'recalculateRealStok'])->name('laporan.stok.saldo-awal.recalculate');
        Route::get('/laporan/stok/mutasi', [LaporanStokController::class, 'mutasiIndex'])->name('laporan.stok.mutasi.index');
        Route::delete('/laporan/stok/mutasi/{id}', [LaporanStokController::class, 'mutasiDestroy'])->name('laporan.stok.mutasi.destroy');
