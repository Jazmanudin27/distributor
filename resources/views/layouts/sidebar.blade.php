    ...
    <div class="sidebar-menu-accordion accordion" id="sidebarMenuAccordion">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <a href="{{ url('/') }}" class="accordion-button no-chevron text-decoration-none sidebar-main-item">
            ...
            <div id="collapseMaster" class="accordion-collapse collapse" aria-labelledby="headingMaster"
                ...
                <div class="accordion-body">
                    <div class="sidebar-submenu-list">
                        @can('view-kategori')
                            <a href="{{ route('kategori.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-tags text-primary"></i> Data Kategori
                            </a>
                        @endcan
                        @can('view-merk')
                            <a href="{{ route('merk.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-copyright text-info"></i> Data Merk
                            </a>
                        @endcan
                        @can('view-supplier')
                            <a href="{{ route('supplier.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-truck text-success"></i> Data Supplier
                            </a>
                        @endcan
                        @can('view-barang')
                            <a href="{{ route('barang.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-boxes-stacked text-warning"></i> Data Barang
                            </a>
                        @endcan
                        @can('view-satuan')
                            <a href="{{ route('barang_satuan.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-balance-scale text-primary"></i> Barang Satuan
                            </a>
                        @endcan
                        @can('view-pelanggan')
                            <a href="{{ route('pelanggan.index') }}"
                                class="sidebar-submenu-item d-flex justify-content-between align-items-center">
                                <span>
                        ...
                        @can('view-diskon_strata')
                            <a href="{{ route('diskon-strata.index') }}" class="sidebar-submenu-item">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTransaksi" class="accordion-collapse collapse" aria-labelledby="headingTransaksi"
                data-bs-parent="#sidebarMenuAccordion">
                <div class="accordion-body">
                    <div class="sidebar-submenu-list">
                        @can('view-penjualan')
                            <a href="{{ route('penjualan.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-file-invoice-dollar text-success"></i> Penjualan
                            </a>
                        @endcan
                        @can('view-retur_penjualan')
                            <a href="{{ route('retur-penjualan.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-rotate-right text-success"></i> Retur Penjualan
                            </a>
                        @endcan
                        @can('view-penjualan_kiriman')
                            <a href="{{ route('penjualan-kiriman.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-truck-ramp-box text-info"></i> Kiriman Penjualan
                            </a>
                        @endcan
                        @can('view-pembelian')
                            <a href="{{ route('pembelian.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-cart-shopping text-warning"></i> Pembelian
                            </a>
                        @endcan
                        @can('view-retur_pembelian')
                            <a href="{{ route('retur-pembelian.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-rotate-left text-danger"></i> Retur Pembelian
                            </a>
                        @endcan
                        @can('view-stok_opname')
                            <a href="{{ route('stok-opname.index') }}" class="sidebar-submenu-item">
                        ...
                        @if ($user->hasRole('Super Admin') || $user->hasRole('Admin') || $user->can('view-kas_bank'))
                            <a href="{{ route('kas-bank.index') }}" class="sidebar-submenu-item">
        ...
        @if ($user->hasRole('Super Admin') || $user->can('view-penjualan'))
            <div class="accordion-item">
                ...
                <div id="collapseSales" class="accordion-collapse collapse" aria-labelledby="headingSales"
                    ...
                    <div class="accordion-body">
                        <div class="sidebar-submenu-list">
                            <a href="{{ route('sales-tracking.index') }}" class="sidebar-submenu-item">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseSetting" class="accordion-collapse collapse" aria-labelledby="headingSetting"
                data-bs-parent="#sidebarMenuAccordion">
                <div class="accordion-body">
                    <div class="sidebar-submenu-list">
                        @can('view-users')
                            <a href="{{ route('users.index') }}" class="sidebar-submenu-item">
                                <i class="fa-solid fa-users text-info"></i> Data Users
                            </a>
                        @endcan
                        @can('view-roles')
                            <a href="{{ route('roles.index') }}" class="sidebar-submenu-item">
