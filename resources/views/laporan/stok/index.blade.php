                    ...
                    <form action="{{ route('laporan.stok.cetak') }}" method="GET" target="_blank">
                        ...
                        <div class="mt-3 d-flex flex-column gap-2">
                            <a href="{{ route('laporan.stok.mutasi.index') }}" 
                               class="btn btn-outline-dark w-100 py-2 fw-bold hover-scale shadow-sm d-flex align-items-center justify-content-center gap-2"
                               style="height: 38px;">
                                <i class="fa-solid fa-clock-rotate-left"></i> Riwayat & Log Mutasi Stok (Detail & Hapus)
                            </a>
