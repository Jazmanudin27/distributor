                ...
                <div class="card-body p-4">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="mb-3 d-none" id="kategori-container">
                            <label for="jenis_barang_kategori" class="form-label fs-7 fw-bold text-secondary">Pilih Kategori
                        ...
                        <div class="mb-3 d-none" id="merk-container">
                            <label for="jenis_barang_merk" class="form-label fs-7 fw-bold text-secondary">Pilih Merk (Bisa
                                Pilih Banyak)</label>
