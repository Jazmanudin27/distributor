        ...
        <div class="col-md-5">
            <div class="card shadow border-0 rounded-4 overflow-hidden">
                <div class="card-header card-premium-header text-white text-center py-4 border-0 d-flex flex-column align-items-center">
                    <h5 class="mb-1 fw-bold text-white">Laporan Pembayaran Piutang</h5>
                    <p class="text-white-50 small mb-0" style="font-size: 11px;">Cetak rekapitulasi atau detail pembayaran piutang pelanggan</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('laporan.pembayaran_piutang.cetak') }}" method="GET" target="_blank">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jenis_laporan" class="form-select form-select-sm">
                                <option value="detail">Format 1: Detail Pembayaran (Per Transaksi)</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold text-secondary mb-1">Status Pembayaran</label>
                            <select name="status_pembayaran" class="form-select form-select-sm select2-init">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <button type="submit" onclick="this.form.action='{{ route('laporan.pembayaran_piutang.cetak') }}'; this.form.target='_blank';"
                            ...
                            <div class="col-6">
                                <button type="submit" onclick="this.form.action='{{ route('laporan.pembayaran_piutang.excel') }}'; this.form.target='_self';"
