        ...
        <div class="col-md-5">
            <div class="card shadow border-0 rounded-4 overflow-hidden">
                <div
                    ...
                    <h5 class="mb-1 fw-bold text-white">Laporan Retur Pembelian</h5>
                    <p class="text-white-50 small mb-0" style="font-size: 11px;">Cetak rekapitulasi atau detail transaksi
                        retur pembelian</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('laporan.retur-pembelian.cetak') }}" method="GET" target="_blank">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-secondary mb-1">Pengelompokan</label>
                            <select name="group_by_supplier" class="form-select form-select-sm">
                                <option value="0">Kronologis (Default)</option>
                                <option value="1">Per Supplier</option>
                            </select>
                        </div>
                        <div class="row g-2">
                            <div class="col-6">
                                <button type="submit" onclick="this.form.action='{{ route('laporan.retur-pembelian.cetak') }}'; this.form.target='_blank';"
                            ...
                            <div class="col-6">
                                <button type="submit" onclick="this.form.action='{{ route('laporan.retur-pembelian.excel') }}'; this.form.target='_self';"
