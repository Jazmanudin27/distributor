...
<head>
    ...
    <meta name="description" content="Login ke DIS - Mobile Portal">
    <title>Login | DIS Mobile</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-brand">
                ...
                <h1 class="auth-title">DIS Mobile</h1>
                <p class="auth-subtitle">Distributor Information System</p>
            </div>

            <form action="{{ route('mobile.login.unified') }}" method="POST" class="auth-form">
                @csrf
