...
@section('content')
    ...
    <div class="tab-content" id="labaRugiTabsContent">
        ...
        <!-- Tab 2: Laba Rugi per Supplier (Rekap & Detail) -->
        <div class="tab-pane fade" id="supplier-content" role="tabpanel" aria-labelledby="supplier-tab">
            <h6 class="fw-bold mb-3 ms-1 text-white" style="font-size: 0.9rem;">
                <i class="fa-solid fa-truck-field text-primary me-2"></i>Laba Rugi per Supplier
            </h6>

            <div class="accordion mb-4" id="accordionSupplier">
                @forelse ($supplierBreakdown as $code => $data)
                    @php
                                        ...
                                        <table class="table table-bordered table-sm table-supplier-detail mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-end" width="90">Omzet</th>
                                                    <th class="text-end" width="80">Laba</th>
                                                </tr>
                                            </thead>
                                            <tbody>
