        ...
        <div class="col-md-5">
            <div class="card shadow border-0 rounded-4 overflow-hidden">
                <div
                    ...
                    <h5 class="mb-1 fw-bold text-white">Laporan Pembelian</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('laporan.pembelian.cetak') }}" method="GET" target="_blank">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <button type="submit" onclick="this.form.action='{{ route('laporan.pembelian.cetak') }}'; this.form.target='_blank';"
                            ...
                            <div class="col-6">
                                <button type="submit" onclick="this.form.action='{{ route('laporan.pembelian.excel') }}'; this.form.target='_self';"
